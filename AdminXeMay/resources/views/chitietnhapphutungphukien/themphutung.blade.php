...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Thêm chi tiết nhập phụ tùng</li>
    </ol>
  </section>
  ...
  <section class="content">
    <!-- Form -->
    <form action="nhapphutungphukien/{{ $id_nhapphutungphukien }}/themchitietphutung" method="post" enctype="application/x-www-form-urlencoded">
      @csrf
