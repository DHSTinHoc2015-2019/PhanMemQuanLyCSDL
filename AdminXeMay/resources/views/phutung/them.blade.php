...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-default">
     <!-- Form -->
     <form action="phutung/them" method="post" enctype="application/x-www-form-urlencoded">
      @csrf
      ...
      <div class="box-body">
        <div class="row">
          ...
          <div class="form-group">
            <label>Loại xe</label>
            <input type="text" class="form-control" placeholder="Nhập loại xe" name="loaixe" required="">
          </div>
          <div class="form-group">
