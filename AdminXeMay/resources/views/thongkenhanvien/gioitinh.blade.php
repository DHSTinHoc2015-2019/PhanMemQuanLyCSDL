...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <b>Thống kê giới tính nhân viên</b>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Admin</a></li>
      <li>Thống kê giới tính nhân viên</li>
    </ol>
  </section>
  ...
  <section class="content">
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <div class="col-xs-12">
              <!-- Form -->
              <form action="thongke/nhanvien/gioitinh" method="post" enctype="application/x-www-form-urlencoded">
                @csrf
                  ...
                  <div class="box-body with-border">
                    ...
                    <div class="col-md-2">
                      <div class="pull-right">
                         @if(!empty($sum))
                        <a class="btn btn-warning" href="nhanvien/xemThongKeGioiTinhPDF" target="blank">
    ...
    <div class="col-md-10">
        @if(!empty($sum))
      <p style="font-size: 1.5em; color: red;">Tổng số lượng nhân viên có giới tính {{ $gioitinh}}: {{ $sum }} <br> Chiếm tỉ lệ {{ $tile }} tổng số nhân viên</p>
      @endif
      </div>
  </div>
  <!-- /.box-body -->
