  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-default">
         <!-- Form -->
      <form action="loaibaohanh/them" method="post" enctype="multipart/form-data">
        @csrf
          ...
          <div class="row">
            <div class="col-md-6">
             <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Nhập tên loại bảo hành" name="tenloaibaohanh" required="">
            </div>
          </div>
          <!-- /.col -->
          <div class="col-md-6">
             <div class="form-group">
              ...
              <input type="number" class="form-control" placeholder="Nhập thời gian bảo hành" name="thoigianbaohanh" required="">
            </div>
          </div>
          <!-- /.col -->
          <div class="col-md-12">
