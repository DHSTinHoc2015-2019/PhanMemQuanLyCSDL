...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Thêm chi tiết hóa đơn bán phụ tùng</li>
    </ol>
  </section>
  ...
  <section class="content">
    <!-- Form -->
    <form action="hoadonbanphutungphukien/{{ $id_banphutungphukien }}/themchitietphutung" method="post" enctype="application/x-www-form-urlencoded">
      @csrf
    <div class="box box-default">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" placeholder="Nhập số lượng" name="soluongban" required="">
                </div>
            </div>
            <!-- /.col -->
            <div class="col-md-6" id="showImg">
              <div class="form-group">
               <!--  
                <div class="form-group">
                  <label>Giá bán</label>
                  <input type="number" class="form-control" placeholder="Nhập giá" name="dongiaban">
                </div>
      ...
      <div class="box-footer">
        <button type="submit" class="btn btn-primary">Lưu lại</button>
         <a href="hoadonbanphutungphukien/{{ $id_banphutungphukien }}"><button type="button" class="btn btn-danger">Hủy bỏ</button></a>
      </div>
    </div>
    </form>
    <!-- /Form -->
