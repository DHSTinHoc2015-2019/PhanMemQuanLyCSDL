...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Thêm chi tiết hóa đơn bán phụ kiện</li>
    </ol>
  </section>
  ...
  <section class="content">
    <!-- Form -->
    <form action="hoadonbanphutungphukien/{{ $id_banphutungphukien }}/themchitietphukien" method="post" enctype="application/x-www-form-urlencoded">
      @csrf
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" placeholder="Nhập số lượng" name="soluongban">
                </div>
            </div>
            <!-- /.col -->
