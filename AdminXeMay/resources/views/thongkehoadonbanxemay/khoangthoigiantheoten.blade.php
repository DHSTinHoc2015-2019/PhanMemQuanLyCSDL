...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <b>Thống kê xe máy bán từ ngày {{ $tungay }} đến ngày {{ $denngay }} theo tên xe</b>
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <div class="col-xs-12">
              <!-- Form -->
              <form action="thongke/hoadonbanxemay/khoangthoigiantheotenxe/{{ $tungay }}/{{ $denngay }}" method="post" enctype="application/x-www-form-urlencoded">
                @csrf
                  ...
                  <div class="box-body with-border">
                    ...
                    <div class="col-md-4">
                      <div class="pull-right">
                         @if(!empty($sum))
                        <a class="btn btn-warning" href="hoadonbanxemay/xemThongKeKhoangThoiGianTenXePDF/{{$tungay}}/{{$denngay}}" target="blank">
