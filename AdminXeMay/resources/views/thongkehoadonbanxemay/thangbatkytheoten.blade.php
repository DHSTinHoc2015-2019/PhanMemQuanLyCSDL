...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <b>Thống kê xe máy bán tháng {{$thang}} năm {{ $nam }} theo tên xe</b>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Admin</a></li>
      <li>Thống kê xe máy bán tháng tháng {{$thang}} năm {{ $nam }} theo tên xe</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <div class="col-xs-12">
              <!-- Form -->
              <form action="thongke/hoadonbanxemay/thangbatkytheotenxe/{{$thang}}/{{$nam}}" method="post" enctype="application/x-www-form-urlencoded">
                @csrf
                  ...
                  <div class="box-body with-border">
                      ...
                      <div class="form-group">
                        <select class="form-control" name="tenxe">
                          <option value="">Chọn</option>
                            ...
                            <option value="{{ $tenxe}}">{{ $tenxe }}</option>
                            @endforeach
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="pull-right">
                         @if(!empty($sum))
                        <a class="btn btn-warning" href="hoadonbanxemay/xemThongKeThangBatKyTenXePDF/{{$thang}}/{{$nam}}" target="blank">
